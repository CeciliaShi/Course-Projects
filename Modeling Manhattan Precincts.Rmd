...
We first convert the address in nyc to lower case. Then, we replace all kinds of abbreviations in the address with its original form. We replace the following:
1.	Directions with its full name (west, south…)
2.	number words (first or 1st…) with numbers (1, 2, …)
3.	All abbreviations of “street”, “avenue”, “broadway”, “square”, “park”, “central park west”, “drive”, “place”, “road” “lane” “circle” and “plaza”  
...
In the end, we polygonise the raster and save it to "precincts.json" with recreated boundaries
